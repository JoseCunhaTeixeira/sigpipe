...
- **Inversion** — Bayesian MCMC inversion of Rayleigh-wave dispersion curves to 1D velocity models (via via [`disba`](https://github.com/keurfonluu/disba) + [`BayesBay`](https://github.com/fmagrini/bayesbay)). Petrophysical inversion of Rayleigh-wave dispersion curves to 1D soil models (via [`silex`](https://github.com/josecunhateixeira/silex)).
